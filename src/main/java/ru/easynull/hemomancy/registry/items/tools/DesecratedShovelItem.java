...
public final class DesecratedShovelItem extends ShovelItem implements Desecrated {
    ...
    public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner) {
        if (!awakened || !state.isIn(BlockTags.SHOVEL_MINEABLE) || !(miner instanceof PlayerEntity player) || player.isSneaking()) {
