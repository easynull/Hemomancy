...
public final class ResearchManager {
    ...
    public static void onInit() {
        add(Hemomancy.path("hemomancy_origins"), HmItems.BOOK.getDefaultStack(), 0, 0, 0,
        ...
        add(Hemomancy.path("life_essence"), HmItems.SACRIFICIAL_DAGGER.getDefaultStack(), 50, 50, 0,
                ...
                new Page(0, new TitleElement(Text.translatable("research.hemomancy.life_essence.title2")),
                        new TextElement(Text.translatable("research.hemomancy.life_essence.desc3"), 120))
        );
        ...
        add(Hemomancy.path("blood_altar_foundations"), HmBlocks.BLOOD_ALTAR.asItem().getDefaultStack(), 0, 100, 0,
                ...
                new Page(0, new TitleElement(Text.translatable("research.hemomancy.blood_altar_foundations.title2")),
                        ...
                        new StructureElement(TierManager.getTiers().get((byte)2), HmBlocks.BLOOD_ALTAR.getDefaultState(), 70)),
                new Page(1, new TitleElement(Text.translatable("research.hemomancy.blood_altar_foundations.title3")),
                        ...
                        new StructureElement(TierManager.getTiers().get((byte)3), HmBlocks.BLOOD_ALTAR.getDefaultState(), 70)),
                new Page(2, new TitleElement(Text.translatable("research.hemomancy.blood_altar_foundations.title4")),
                        ...
                        new StructureElement(TierManager.getTiers().get((byte)4), HmBlocks.BLOOD_ALTAR.getDefaultState(), 80)),
                new Page(4, new TitleElement(Text.translatable("research.hemomancy.blood_altar_foundations.title5")),
                        ...
                        new StructureElement(TierManager.getTiers().get((byte)5), HmBlocks.BLOOD_ALTAR.getDefaultState(), 80)),
                new Page(6, new TitleElement(Text.translatable("research.hemomancy.blood_altar_foundations.title6")),
                        ...
                        new StructureElement(TierManager.getTiers().get((byte)6), HmBlocks.BLOOD_ALTAR.getDefaultState(), 80))
        );

        add(Hemomancy.path("blood_orbs"), HmItems.WEAK_BLOOD_ORB.getDefaultStack(), -100, 150, 0,
